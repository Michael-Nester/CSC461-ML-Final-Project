...
class EnhancedTraining:
    ...
    def train_model(self, epochs=100, patience=10):
        ...
        with open('../csc461/brn/losses2.txt', 'w') as f:
        ...
        for epoch in range(epochs):
            ...
            # Save losses
            with open('../csc461/brn/losses2.txt', 'a') as f:
    ...
    for epoch in range(num_epochs):
       ...
       # Validation phase
        ...
        if val_acc > best_val_acc:
            ...
            }, 'best_eye_color_classifier4.pth')
...
def main():
    ...
    # Paths
    image_dir = "../csc461/brn/CLASSES_400_300_Part1"

    labels_csv = "../csc461/brn/iris_labels_part1.csv"
    ...
    trainer.save_model('best_eye_color_classifier4.pth', color_to_idx)
