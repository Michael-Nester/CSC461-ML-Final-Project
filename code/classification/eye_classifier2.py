...
def load_data(image_dir, labels_csv):
    ...
    print("unique eye colors found: ", df['label'].unique())
    ...
    unique_colors = df['filename'].unique()
    ...
    for _, row in df.iterrows():
        ...
        if os.path.exists(image_path):
            try:
                ...
                #print(f"Warning: Unknown eye color '{eye_color}' for image {image_name}")
                continue
    print(f"Totoal images: {len(image_paths)}")
